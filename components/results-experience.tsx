...
export function ResultsExperience() {
  ...
  return (
    <main className="results-page">
      <header className="site-header site-header--results"><a className="brand" href="/"><span className="brand-mark"><span /></span><span>maré<span className="brand-dot">.</span></span></a><nav className="desktop-nav"><a href="#como-funciona">Como funciona</a><a href="#fontes">Nossas fontes</a><a href="#sobre">Sobre a Maré</a></nav><div className="header-actions"><a className="header-link" href="/favoritos">Favoritos</a><button className="header-link">Entrar</button><button className="button button--outline button--small">Anunciar imóvel</button><button className="mobile-menu" aria-label="Abrir menu"><MenuIcon /></button></div></header>
